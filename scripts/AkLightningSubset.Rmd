...
st_write(joinSelect, "../outputs/spatialDataCreate/AkLightning13_23.shp", driver="ESRI Shapefile")
```

```{r}
st_write(joinSelect, dsn= "../outputs/spatialDataCreate/AkLightning13_23.gpkg", layer='lightning')
```
...
```
```{r}
write_csv(joinSelectDf ,"../outputs/spatialDataCreate/AkLightning13_23.csv")
```
# Geo package
```{r}
